...
/// <summary>
/// Parameters for the <c>copyMessage</c> method.
/// </summary>
public sealed class CopyMessageParameters : ApiRequestParameters
{
    ...
    /// <summary>Identifier of the message to copy.</summary>
    public required long MessageId { get; init; }

    /// <summary>Start timestamp for copied video messages.</summary>
    public int? VideoStartTimestamp { get; init; }

    /// <summary>New caption for the copied message.</summary>
