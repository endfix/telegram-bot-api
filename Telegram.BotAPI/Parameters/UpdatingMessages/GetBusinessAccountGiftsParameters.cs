...
/// <summary>
/// Parameters for the <c>getBusinessAccountGifts</c> method.
/// </summary>
public class GetBusinessAccountGiftsParameters : ApiRequestParameters
{
    ...
    /// <summary>Whether to exclude gifts not saved to the account's profile.</summary>
    public bool? ExcludeUnsaved { get; init; }

    /// <summary>Whether to exclude gifts saved to the account's profile.</summary>
