...
{
    /// <summary>Identifier of the small chat photo file, usable only for downloading while the photo remains unchanged.</summary>
    ...
    /// <summary>Identifier of the big chat photo file, usable only for downloading while the photo remains unchanged.</summary>
