...
public sealed class InputSticker
{
    ...
    /// Animated and video stickers can't be uploaded via HTTP URL. <see href="https://core.telegram.org/bots/api#sending-files">More information on Sending Files »</see>
    /// </summary>
